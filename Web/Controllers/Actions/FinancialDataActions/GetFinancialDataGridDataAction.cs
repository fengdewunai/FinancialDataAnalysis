...
namespace Web.Controllers.Actions.FinancialDataActions
{
    ...
    public class GetFinancialDataGridDataAction
    {
        ...
        /// <returns></returns>
        public DynamicGridDataModel Process(int excelId, string accountItemIds, string financialDataItemIds, int qiJianTypeId)
        {
            return _financialDataExtendBLL.GetGridData(excelId, accountItemIds, financialDataItemIds, qiJianTypeId);
        }
