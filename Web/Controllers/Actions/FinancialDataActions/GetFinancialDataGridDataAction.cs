...
namespace Web.Controllers.Actions.FinancialDataActions
{
    ...
    public class GetFinancialDataGridDataAction
    {
        ...
        /// <returns></returns>
        public DynamicGridDataModel Process(int excelId, string accountItemIds, string financialDataItemIds, int qiJianTypeId, int onlyStatisticChildren, int xiangMuTreeTypeId, int statisticAccountChildren)
        {
            return _financialDataExtendBLL.GetGridData(excelId, accountItemIds, financialDataItemIds, qiJianTypeId, onlyStatisticChildren, xiangMuTreeTypeId, statisticAccountChildren);
        }
